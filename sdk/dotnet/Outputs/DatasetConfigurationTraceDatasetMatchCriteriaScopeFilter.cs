...
namespace Chronosphere.Pulumi.Outputs
{
    ...
    public sealed class DatasetConfigurationTraceDatasetMatchCriteriaScopeFilter
    {
        ...
        [OutputConstructor]
        private DatasetConfigurationTraceDatasetMatchCriteriaScopeFilter(ImmutableArray<Outputs.DatasetConfigurationTraceDatasetMatchCriteriaScopeFilterSpanScope> spanScopes)
        {
