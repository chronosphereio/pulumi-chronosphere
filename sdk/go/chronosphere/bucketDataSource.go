...
func BucketDataSourceOutput(ctx *pulumi.Context, args BucketDataSourceOutputArgs, opts ...pulumi.InvokeOption) BucketDataSourceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (BucketDataSourceResultOutput, error) {
			args := v.(BucketDataSourceArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("chronosphere:index/bucketDataSource:BucketDataSource", args, BucketDataSourceResultOutput{}, options).(BucketDataSourceResultOutput), nil
