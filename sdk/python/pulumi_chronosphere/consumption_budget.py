...
class ConsumptionBudgetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] consumption_config_id: ID of the singleton `ConsumptionConfig` resource this budget depends on. Acts as an explicit dependency pointer; the actual partition is selected via `partition_slug_path`.
        :param pulumi.Input[str] name: Display name of the consumption budget. Can be changed after creation.
        ...
        :param pulumi.Input[int] default_priority: Priority assigned to requests that do not match any entry in `priority`. Defaults to 10 (dropped first) if unset.
        :param pulumi.Input[str] notification_policy_id: ID of the notification policy used to route alerts generated by `ALERT_WARN`/`ALERT_CRITICAL` thresholds. Required only if such thresholds are configured.
        :param pulumi.Input[str] partition_slug_path: Forward-slash-delimited path identifying the partition the budget applies to (e.g. `global/gateway/dev`). Must start with the `global` partition slug.
        :param pulumi.Input[Sequence[pulumi.Input['ConsumptionBudgetPriorityArgs']]] priorities: Priority order used when dropping data. Priority `10` is dropped first; priority `1` is dropped last.
        :param pulumi.Input[str] resource: Deprecated: use `threshold.sku_group` and `threshold.unit` instead. Identifies the resource type the budget governs.
        :param pulumi.Input[str] slug: Stable identifier for the consumption budget. Generated from `name` if omitted. Immutable after creation.
...
class ConsumptionBudget(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['ConsumptionBudgetAlertActionConfigArgs']] alert_action_config: Optional configuration applied to monitors generated by alerting thresholds.
        :param pulumi.Input[str] consumption_config_id: ID of the singleton `ConsumptionConfig` resource this budget depends on. Acts as an explicit dependency pointer; the actual partition is selected via `partition_slug_path`.
        :param pulumi.Input[int] default_priority: Priority assigned to requests that do not match any entry in `priority`. Defaults to 10 (dropped first) if unset.
        :param pulumi.Input[str] name: Display name of the consumption budget. Can be changed after creation.
        :param pulumi.Input[str] notification_policy_id: ID of the notification policy used to route alerts generated by `ALERT_WARN`/`ALERT_CRITICAL` thresholds. Required only if such thresholds are configured.
        :param pulumi.Input[str] partition_slug_path: Forward-slash-delimited path identifying the partition the budget applies to (e.g. `global/gateway/dev`). Must start with the `global` partition slug.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConsumptionBudgetPriorityArgs']]]] priorities: Priority order used when dropping data. Priority `10` is dropped first; priority `1` is dropped last.
        :param pulumi.Input[str] resource: Deprecated: use `threshold.sku_group` and `threshold.unit` instead. Identifies the resource type the budget governs.
        :param pulumi.Input[str] slug: Stable identifier for the consumption budget. Generated from `name` if omitted. Immutable after creation.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ConsumptionBudgetThresholdArgs']]]] thresholds: Threshold actions to take when budget consumption crosses configured levels.
        """
        ...
    @overload
    def __init__(__self__,
