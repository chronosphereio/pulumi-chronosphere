...
def service_data_source(slug: Optional[_builtins.str] = None,
    ...
    :param _builtins.str slug: Slug of the service to look up.
    """
    __args__ = dict()
    __args__['slug'] = slug
...
def service_data_source_output(slug: pulumi.Input[Optional[_builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[ServiceDataSourceResult]:
    """
    Read-only data source that retrieves an existing service by slug. Services are typically discovered automatically from incoming telemetry; use this data source to reference one from Terraform-managed resources.
    ...
    __ret__ = pulumi.runtime.invoke_output('chronosphere:index/serviceDataSource:ServiceDataSource', __args__, opts=opts, typ=ServiceDataSourceResult)
    return __ret__.apply(lambda __response__: ServiceDataSourceResult(
