...
function pack(dir, out) {
    return __awaiter(this, void 0, void 0, function* () {
        const { stdout } = yield execa_1.default("npm", ["pack"], { cwd: dir });
        const tarball = stdout.trim();
        const tarballPath = path.join(dir, tarball);
        try {
            yield fs.rename(tarballPath, out);
        }
        catch (error) {
            // Rename can fail if we move across devices on Windows, fallback to
            // copying and removing.
            yield fs.copyFile(tarballPath, out);
            yield fs.unlink(tarballPath);
        }
    });
}
...
function run(typescriptVersion, nodeTypesVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield pack(sdkRootBin, pulumiPackagePath);
