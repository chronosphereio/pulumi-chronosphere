...
export interface ConsumptionConfigPartitionFilterCondition {
     ...
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionFilterConditionTraceSpanFilter {
     ...
     */
    duration?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionFilterConditionTraceSpanFilterTag {
     ...
     */
    numericValue?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionFilterConditionTraceSpanFilterTagValue;
}
...
export interface ConsumptionConfigPartitionPartitionFilterCondition {
     ...
     * Span-level trace filters matched against incoming trace data. A span matches the condition only if it satisfies every filter in the block.
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilter {
     ...
     * Matches traces or spans whose duration in seconds falls within the inclusive `[min_secs, maxSecs]` range.
     */
    duration?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterTag {
     ...
     * Matches traces or spans where the target numeric field satisfies the comparison against `value`.
     */
    numericValue?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionPartitionFilterConditionTraceSpanFilterTagValue;
}
...
export interface ConsumptionConfigPartitionPartitionPartitionFilterCondition {
     ...
     * Span-level trace filters matched against incoming trace data. A span matches the condition only if it satisfies every filter in the block.
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilter {
     ...
     * Matches traces or spans whose duration in seconds falls within the inclusive `[min_secs, maxSecs]` range.
     */
    duration?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterTag {
     ...
     * Matches traces or spans where the target numeric field satisfies the comparison against `value`.
     */
    numericValue?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionPartitionPartitionFilterConditionTraceSpanFilterTagValue;
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionFilterCondition {
     ...
     * Span-level trace filters matched against incoming trace data. A span matches the condition only if it satisfies every filter in the block.
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter {
     ...
     * Matches traces or spans whose duration in seconds falls within the inclusive `[min_secs, maxSecs]` range.
     */
    duration?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag {
     ...
     * Matches traces or spans where the target numeric field satisfies the comparison against `value`.
     */
    numericValue?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagValue;
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterCondition {
     ...
     * Span-level trace filters matched against incoming trace data. A span matches the condition only if it satisfies every filter in the block.
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter {
     ...
     * Matches traces or spans whose duration in seconds falls within the inclusive `[min_secs, maxSecs]` range.
     */
    duration?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag {
     ...
     * Matches traces or spans where the target numeric field satisfies the comparison against `value`.
     */
    numericValue?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagValue;
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterCondition {
     ...
     * Span-level trace filters matched against incoming trace data. A span matches the condition only if it satisfies every filter in the block.
     */
    traceSpanFilters?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilter {
     ...
     * Matches traces or spans whose duration in seconds falls within the inclusive `[min_secs, maxSecs]` range.
     */
    duration?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterDuration;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    error?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterError;
    /**
     * Matches traces or spans where the target boolean field equals `value`.
     */
    isRootSpan?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterIsRootSpan;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    operation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentOperation?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentOperation;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    parentService?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterParentService;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    service?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterService;
    /**
     * Matches spans whose tag (span attribute) with the given `key` has a value satisfying the nested string or numeric filter.
     */
    tags?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag[];
}
...
export interface ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTag {
     ...
     * Matches traces or spans where the target numeric field satisfies the comparison against `value`.
     */
    numericValue?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagNumericValue;
    /**
     * Matches traces or spans where the target string field satisfies the match condition.
     */
    value?: outputs.ConsumptionConfigPartitionPartitionPartitionPartitionPartitionPartitionFilterConditionTraceSpanFilterTagValue;
}
