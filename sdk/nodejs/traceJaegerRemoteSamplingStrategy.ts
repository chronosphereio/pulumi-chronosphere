...
export class TraceJaegerRemoteSamplingStrategy extends pulumi.CustomResource {
     ...
     */
    declare public readonly appliedStrategy: pulumi.Output<outputs.TraceJaegerRemoteSamplingStrategyAppliedStrategy>;
    /**
    ...
    constructor(name: string, argsOrState?: TraceJaegerRemoteSamplingStrategyArgs | TraceJaegerRemoteSamplingStrategyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["appliedStrategy"] = state?.appliedStrategy;
            resourceInputs["name"] = state?.name;
            resourceInputs["serviceName"] = state?.serviceName;
            resourceInputs["slug"] = state?.slug;
        } else {
            const args = argsOrState as TraceJaegerRemoteSamplingStrategyArgs | undefined;
            if (args?.appliedStrategy === undefined && !opts.urn) {
            ...
            resourceInputs["appliedStrategy"] = args?.appliedStrategy;
...
export interface TraceJaegerRemoteSamplingStrategyState {
     ...
     * Sampling strategy returned to the Jaeger client. Exactly one of `probabilisticStrategy`, `rateLimitingStrategy`, or `perOperationStrategies` must be set.
     */
    appliedStrategy?: pulumi.Input<inputs.TraceJaegerRemoteSamplingStrategyAppliedStrategy | undefined>;
    /**
     * Display name of the Jaeger remote sampling strategy.
     */
