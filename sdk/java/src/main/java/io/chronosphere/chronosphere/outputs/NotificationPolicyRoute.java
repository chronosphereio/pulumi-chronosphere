...
public final class NotificationPolicyRoute {
    ...
    public static Builder builder(NotificationPolicyRoute defaults) {
    ...
    public static final class Builder {
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("NotificationPolicyRoute", "severity");
            }
            this.severity = severity;
            return this;
        }
        public NotificationPolicyRoute build() {
            final var _resultValue = new NotificationPolicyRoute();
