...
public final class SLODefinitionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param burnRateAlertingConfigs Custom burn-rate alert definitions. If omitted, the system default burn rates are used. Only takes effect when `enableBurnRateAlerting` is true.
         * 
         * @return builder
         * 
         */
        ...
        public SLODefinitionArgs build() {
            if ($.objective == null) {
                throw new MissingRequiredPropertyException("SLODefinitionArgs", "objective");
            }
            return $;
        }
    }
