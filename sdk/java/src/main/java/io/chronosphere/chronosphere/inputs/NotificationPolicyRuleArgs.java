...
public final class NotificationPolicyRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationPolicyRuleArgs Empty = new NotificationPolicyRuleArgs();
    ...
    private NotificationPolicyRuleArgs() {}

    private NotificationPolicyRuleArgs(NotificationPolicyRuleArgs $) {
    ...
    public static Builder builder(NotificationPolicyRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyRuleArgs();
        }

        public Builder(NotificationPolicyRuleArgs defaults) {
            $ = new NotificationPolicyRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NotificationPolicyRuleArgs build() {
