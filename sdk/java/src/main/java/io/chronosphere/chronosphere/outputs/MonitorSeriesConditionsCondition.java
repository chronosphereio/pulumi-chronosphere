...
import io.chronosphere.chronosphere.outputs.MonitorSeriesConditionsConditionResolveValue;
...
public final class MonitorSeriesConditionsCondition {
     ...
     * 
     */
    private @Nullable MonitorSeriesConditionsConditionResolveValue resolveValue;
    /**
     ...
     * 
     */
    public Optional<MonitorSeriesConditionsConditionResolveValue> resolveValue() {
    ...
    public static final class Builder {
        ...
        public Builder op(String op) {
            if (op == null) {
              throw new MissingRequiredPropertyException("MonitorSeriesConditionsCondition", "op");
            }
            this.op = op;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder resolveValue(@Nullable MonitorSeriesConditionsConditionResolveValue resolveValue) {
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("MonitorSeriesConditionsCondition", "severity");
            }
        ...
        public MonitorSeriesConditionsCondition build() {
            final var _resultValue = new MonitorSeriesConditionsCondition();
            _resultValue.op = op;
            _resultValue.resolveSustain = resolveSustain;
            _resultValue.resolveValue = resolveValue;
            _resultValue.severity = severity;
            _resultValue.sustain = sustain;
