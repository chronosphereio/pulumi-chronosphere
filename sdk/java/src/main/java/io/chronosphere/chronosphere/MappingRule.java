...
public class MappingRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public MappingRule(java.lang.String name) {
     ...
     */
    public MappingRule(java.lang.String name, MappingRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MappingRule(java.lang.String name, MappingRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/mappingRule:MappingRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MappingRule(java.lang.String name, Output<java.lang.String> id, @Nullable MappingRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/mappingRule:MappingRule", name, state, makeResourceOptions(options, id), false);
    }

    private static MappingRuleArgs makeArgs(MappingRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MappingRuleArgs.Empty : args;
    }
     ...
     */
    public static MappingRule get(java.lang.String name, Output<java.lang.String> id, @Nullable MappingRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
