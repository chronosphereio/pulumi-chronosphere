...
public final class LogscaleActionEmailAction {
    ...
    public static final class Builder {
        ...
        public Builder recipients(List<String> recipients) {
            if (recipients == null) {
              throw new MissingRequiredPropertyException("LogscaleActionEmailAction", "recipients");
            }
        ...
        public LogscaleActionEmailAction build() {
            final var _resultValue = new LogscaleActionEmailAction();
            _resultValue.attachCsv = attachCsv;
