...
public final class ConsumptionBudgetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ConsumptionBudgetArgs build() {
            if ($.consumptionConfigId == null) {
                throw new MissingRequiredPropertyException("ConsumptionBudgetArgs", "consumptionConfigId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ConsumptionBudgetArgs", "name");
            }
            return $;
        }
    }
