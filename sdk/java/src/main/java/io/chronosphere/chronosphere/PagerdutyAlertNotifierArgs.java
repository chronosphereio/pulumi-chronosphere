...
public final class PagerdutyAlertNotifierArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PagerdutyAlertNotifierArgs() {}

    private PagerdutyAlertNotifierArgs(PagerdutyAlertNotifierArgs $) {
    ...
    public static Builder builder(PagerdutyAlertNotifierArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PagerdutyAlertNotifierArgs();
        }

        public Builder(PagerdutyAlertNotifierArgs defaults) {
        ...
        /**
         * @param basicAuthUsername Username for HTTP basic auth when calling the PagerDuty API. Mutually exclusive with `bearerToken`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param routingKey PagerDuty integration key when using the `Events API v2` integration type. Treat as a secret. Mutually exclusive with `serviceKey`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serviceKey PagerDuty integration key when using the `Prometheus` integration type. Treat as a secret. Mutually exclusive with `routingKey`.
         * 
         * @return builder
         * 
         */
        ...
        public PagerdutyAlertNotifierArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PagerdutyAlertNotifierArgs", "name");
            }
            if ($.severity == null) {
                throw new MissingRequiredPropertyException("PagerdutyAlertNotifierArgs", "severity");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("PagerdutyAlertNotifierArgs", "url");
            }
            return $;
        }
    }
