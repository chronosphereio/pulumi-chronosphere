...
public final class LogscaleActionSlackPostMessageActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogscaleActionSlackPostMessageActionArgs build() {
            if ($.apiToken == null) {
                throw new MissingRequiredPropertyException("LogscaleActionSlackPostMessageActionArgs", "apiToken");
            }
            if ($.channels == null) {
                throw new MissingRequiredPropertyException("LogscaleActionSlackPostMessageActionArgs", "channels");
            }
            return $;
        }
    }
