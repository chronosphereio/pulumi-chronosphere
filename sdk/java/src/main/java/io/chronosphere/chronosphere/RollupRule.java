 ...
 * import io.chronosphere.chronosphere.RollupRule;
 * import io.chronosphere.chronosphere.RollupRuleArgs;
...
public class RollupRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public RollupRule(java.lang.String name) {
     ...
     */
    public RollupRule(java.lang.String name, RollupRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RollupRule(java.lang.String name, RollupRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/rollupRule:RollupRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RollupRule(java.lang.String name, Output<java.lang.String> id, @Nullable RollupRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/rollupRule:RollupRule", name, state, makeResourceOptions(options, id), false);
    }

    private static RollupRuleArgs makeArgs(RollupRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RollupRuleArgs.Empty : args;
    }
     ...
     */
    public static RollupRule get(java.lang.String name, Output<java.lang.String> id, @Nullable RollupRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
