...
public final class MonitorSeriesConditionsOverrideConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MonitorSeriesConditionsOverrideConditionArgs build() {
            if ($.op == null) {
                throw new MissingRequiredPropertyException("MonitorSeriesConditionsOverrideConditionArgs", "op");
            }
            if ($.severity == null) {
                throw new MissingRequiredPropertyException("MonitorSeriesConditionsOverrideConditionArgs", "severity");
            }
            return $;
        }
    }
