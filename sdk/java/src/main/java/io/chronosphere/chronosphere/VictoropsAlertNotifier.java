 ...
 * import com.pulumi.core.Output;
 * import io.chronosphere.chronosphere.VictoropsAlertNotifier;
 * import io.chronosphere.chronosphere.VictoropsAlertNotifierArgs;
...
public class VictoropsAlertNotifier extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return Username for HTTP basic auth when calling the VictorOps API. Mutually exclusive with `bearerToken`.
     * 
     */
     ...
     */
    public VictoropsAlertNotifier(java.lang.String name) {
     ...
     */
    public VictoropsAlertNotifier(java.lang.String name, VictoropsAlertNotifierArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VictoropsAlertNotifier(java.lang.String name, VictoropsAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/victoropsAlertNotifier:VictoropsAlertNotifier", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VictoropsAlertNotifier(java.lang.String name, Output<java.lang.String> id, @Nullable VictoropsAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/victoropsAlertNotifier:VictoropsAlertNotifier", name, state, makeResourceOptions(options, id), false);
    }

    private static VictoropsAlertNotifierArgs makeArgs(VictoropsAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VictoropsAlertNotifierArgs.Empty : args;
    }
     ...
     */
    public static VictoropsAlertNotifier get(java.lang.String name, Output<java.lang.String> id, @Nullable VictoropsAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
