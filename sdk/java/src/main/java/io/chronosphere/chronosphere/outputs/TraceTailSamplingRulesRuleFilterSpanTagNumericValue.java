...
public final class TraceTailSamplingRulesRuleFilterSpanTagNumericValue {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterSpanTagNumericValue", "comparison");
            }
        ...
        public Builder value(Double value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterSpanTagNumericValue", "value");
            }
            this.value = value;
            return this;
        }
        public TraceTailSamplingRulesRuleFilterSpanTagNumericValue build() {
            final var _resultValue = new TraceTailSamplingRulesRuleFilterSpanTagNumericValue();
