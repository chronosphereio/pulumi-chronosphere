...
public final class LogControlConfigState extends com.pulumi.resources.ResourceArgs {
    ...
    private LogControlConfigState() {}

    private LogControlConfigState(LogControlConfigState $) {
        this.rules = $.rules;
    }
    ...
    public static Builder builder(LogControlConfigState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogControlConfigState();
        }

        public Builder(LogControlConfigState defaults) {
        ...
        public LogControlConfigState build() {
            return $;
        }
    }
