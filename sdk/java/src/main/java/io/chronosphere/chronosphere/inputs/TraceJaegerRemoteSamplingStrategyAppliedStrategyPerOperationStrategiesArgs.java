...
public final class TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param perOperationStrategies Operation-specific overrides that take precedence over `defaultSamplingRate`.
         * 
         * @return builder
         * 
         */
        ...
        public TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesArgs build() {
            if ($.defaultSamplingRate == null) {
                throw new MissingRequiredPropertyException("TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesArgs", "defaultSamplingRate");
            }
            return $;
        }
    }
