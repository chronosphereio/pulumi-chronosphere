...
@CustomType
public final class ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities {
    /**
    ...
    private ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities() {}
    /**
     * @return Threshold expressed as a fixed value of the license, in the license&#39;s native unit.
     * 
     */
    ...
    public static Builder builder(ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentOfPoolAllocation;
        public Builder() {}
        public Builder(ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities defaults) {
        ...
        public ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities build() {
            final var _resultValue = new ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdAllPriorities();
