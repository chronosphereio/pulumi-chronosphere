    ...
    public static final class Builder {
        ...
        public Builder sourceValueGlobs(List<String> sourceValueGlobs) {
            if (sourceValueGlobs == null) {
              throw new MissingRequiredPropertyException("DerivedLabelMetricLabelMappingLabelNameMappingValueMapping", "sourceValueGlobs");
            }
        ...
        public Builder targetValue(String targetValue) {
            if (targetValue == null) {
              throw new MissingRequiredPropertyException("DerivedLabelMetricLabelMappingLabelNameMappingValueMapping", "targetValue");
            }
            this.targetValue = targetValue;
            return this;
        }
        public DerivedLabelMetricLabelMappingLabelNameMappingValueMapping build() {
            final var _resultValue = new DerivedLabelMetricLabelMappingLabelNameMappingValueMapping();
