...
public final class DatasetConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param type Dataset type. Determines which of `traceDataset` or `logDataset` must be set.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetConfigurationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DatasetConfigurationArgs", "type");
            }
            return $;
        }
    }
