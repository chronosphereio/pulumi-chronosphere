...
public final class VictoropsAlertNotifierArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param basicAuthUsername Username for HTTP basic auth when calling the VictorOps API. Mutually exclusive with `bearerToken`.
         * 
         * @return builder
         * 
         */
        ...
        public VictoropsAlertNotifierArgs build() {
            if ($.apiKey == null) {
                throw new MissingRequiredPropertyException("VictoropsAlertNotifierArgs", "apiKey");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("VictoropsAlertNotifierArgs", "name");
            }
            if ($.routingKey == null) {
                throw new MissingRequiredPropertyException("VictoropsAlertNotifierArgs", "routingKey");
            }
            return $;
        }
    }
