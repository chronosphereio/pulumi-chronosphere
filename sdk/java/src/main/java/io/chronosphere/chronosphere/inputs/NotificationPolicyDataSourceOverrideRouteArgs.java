...
public final class NotificationPolicyDataSourceOverrideRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationPolicyDataSourceOverrideRouteArgs Empty = new NotificationPolicyDataSourceOverrideRouteArgs();
    ...
    private NotificationPolicyDataSourceOverrideRouteArgs() {}

    private NotificationPolicyDataSourceOverrideRouteArgs(NotificationPolicyDataSourceOverrideRouteArgs $) {
    ...
    public static Builder builder(NotificationPolicyDataSourceOverrideRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyDataSourceOverrideRouteArgs();
        }

        public Builder(NotificationPolicyDataSourceOverrideRouteArgs defaults) {
            $ = new NotificationPolicyDataSourceOverrideRouteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NotificationPolicyDataSourceOverrideRouteArgs build() {
