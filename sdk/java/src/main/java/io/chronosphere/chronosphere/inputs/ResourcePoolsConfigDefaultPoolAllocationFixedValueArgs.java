...
public final class ResourcePoolsConfigDefaultPoolAllocationFixedValueArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ResourcePoolsConfigDefaultPoolAllocationFixedValueArgs build() {
            if ($.license == null) {
                throw new MissingRequiredPropertyException("ResourcePoolsConfigDefaultPoolAllocationFixedValueArgs", "license");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("ResourcePoolsConfigDefaultPoolAllocationFixedValueArgs", "value");
            }
            return $;
        }
    }
