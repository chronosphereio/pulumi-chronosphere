...
public final class MonitorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return ID of the bucket the monitor belongs to. Exactly one of `bucketId` or `collectionId` must be set.
     * 
     */
    ...
    /**
     * @return ID of the collection the monitor belongs to. Exactly one of `bucketId` or `collectionId` must be set.
     * 
     */
    ...
    /**
     * @return Display name of the monitor.
     * 
     */
    ...
    /**
     * @return Query that produces the time series evaluated by the monitor. Exactly one of `prometheusExpr`, `graphiteExpr`, or `loggingExpr` must be set.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param bucketId ID of the bucket the monitor belongs to. Exactly one of `bucketId` or `collectionId` must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param collectionId ID of the collection the monitor belongs to. Exactly one of `bucketId` or `collectionId` must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name Display name of the monitor.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param query Query that produces the time series evaluated by the monitor. Exactly one of `prometheusExpr`, `graphiteExpr`, or `loggingExpr` must be set.
         * 
         * @return builder
         * 
         */
        ...
        public MonitorArgs build() {
            ...
            if ($.seriesConditions == null) {
                throw new MissingRequiredPropertyException("MonitorArgs", "seriesConditions");
            }
            return $;
        }
    }
