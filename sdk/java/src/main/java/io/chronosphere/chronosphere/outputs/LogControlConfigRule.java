...
public final class LogControlConfigRule {
    ...
    /**
     * @return Type of control action this rule performs. Exactly one of the matching action blocks (`sample`, `dropField`, `emitMetrics`, `replaceField`, `parseField`) must be configured.
     * 
     */
    ...
    public static final class Builder {
        ...
        public LogControlConfigRule build() {
            final var _resultValue = new LogControlConfigRule();
            _resultValue.dropField = dropField;
            _resultValue.emitMetrics = emitMetrics;
            _resultValue.filter = filter;
            _resultValue.mode = mode;
            _resultValue.name = name;
            _resultValue.parseField = parseField;
            _resultValue.replaceField = replaceField;
