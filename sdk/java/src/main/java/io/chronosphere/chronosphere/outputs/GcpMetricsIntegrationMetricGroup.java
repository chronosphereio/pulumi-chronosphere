...
public final class GcpMetricsIntegrationMetricGroup {
    ...
    public static final class Builder {
        ...
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("GcpMetricsIntegrationMetricGroup", "projectId");
            }
        ...
        public GcpMetricsIntegrationMetricGroup build() {
            final var _resultValue = new GcpMetricsIntegrationMetricGroup();
            _resultValue.filters = filters;
            _resultValue.prefixes = prefixes;
            _resultValue.projectId = projectId;
            _resultValue.rollupRules = rollupRules;
            return _resultValue;
        }
    }
}
