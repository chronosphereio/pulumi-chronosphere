 ...
 * import com.pulumi.core.Output;
 * import io.chronosphere.chronosphere.PagerdutyAlertNotifier;
 * import io.chronosphere.chronosphere.PagerdutyAlertNotifierArgs;
...
public class PagerdutyAlertNotifier extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return Username for HTTP basic auth when calling the PagerDuty API. Mutually exclusive with `bearerToken`.
     * 
     */
    ...
    /**
     * @return PagerDuty integration key when using the `Events API v2` integration type. Treat as a secret. Mutually exclusive with `serviceKey`.
     * 
     */
    ...
    /**
     * @return PagerDuty integration key when using the `Prometheus` integration type. Treat as a secret. Mutually exclusive with `routingKey`.
     * 
     */
     ...
     */
    public PagerdutyAlertNotifier(java.lang.String name) {
     ...
     */
    public PagerdutyAlertNotifier(java.lang.String name, PagerdutyAlertNotifierArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PagerdutyAlertNotifier(java.lang.String name, PagerdutyAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/pagerdutyAlertNotifier:PagerdutyAlertNotifier", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PagerdutyAlertNotifier(java.lang.String name, Output<java.lang.String> id, @Nullable PagerdutyAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/pagerdutyAlertNotifier:PagerdutyAlertNotifier", name, state, makeResourceOptions(options, id), false);
    }

    private static PagerdutyAlertNotifierArgs makeArgs(PagerdutyAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PagerdutyAlertNotifierArgs.Empty : args;
    }
     ...
     */
    public static PagerdutyAlertNotifier get(java.lang.String name, Output<java.lang.String> id, @Nullable PagerdutyAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
