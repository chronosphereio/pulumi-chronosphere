...
public final class TraceMetricsRuleGroupByArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TraceMetricsRuleGroupByArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("TraceMetricsRuleGroupByArgs", "key");
            }
            if ($.label == null) {
                throw new MissingRequiredPropertyException("TraceMetricsRuleGroupByArgs", "label");
            }
            return $;
        }
    }
