...
public final class TraceTailSamplingRulesRuleFilterSpanError {
    ...
    public static final class Builder {
        ...
        public Builder value(Boolean value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterSpanError", "value");
            }
            this.value = value;
            return this;
        }
        public TraceTailSamplingRulesRuleFilterSpanError build() {
            final var _resultValue = new TraceTailSamplingRulesRuleFilterSpanError();
