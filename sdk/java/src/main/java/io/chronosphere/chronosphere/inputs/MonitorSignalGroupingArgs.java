...
public final class MonitorSignalGroupingArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitorSignalGroupingArgs Empty = new MonitorSignalGroupingArgs();
    ...
    private MonitorSignalGroupingArgs() {}

    private MonitorSignalGroupingArgs(MonitorSignalGroupingArgs $) {
    ...
    public static Builder builder(MonitorSignalGroupingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorSignalGroupingArgs();
        }

        public Builder(MonitorSignalGroupingArgs defaults) {
            $ = new MonitorSignalGroupingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitorSignalGroupingArgs build() {
            return $;
        }
    }
