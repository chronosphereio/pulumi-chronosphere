    ...
    public static final class Builder {
        ...
        public DerivedLabelMetricLabelMappingLabelNameMappingValueMappingArgs build() {
            if ($.sourceValueGlobs == null) {
                throw new MissingRequiredPropertyException("DerivedLabelMetricLabelMappingLabelNameMappingValueMappingArgs", "sourceValueGlobs");
            }
            if ($.targetValue == null) {
                throw new MissingRequiredPropertyException("DerivedLabelMetricLabelMappingLabelNameMappingValueMappingArgs", "targetValue");
            }
            return $;
        }
    }
