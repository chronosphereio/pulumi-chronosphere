...
public final class TraceTailSamplingRulesRuleFilterTraceError {
    ...
    public static final class Builder {
        ...
        public Builder value(Boolean value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterTraceError", "value");
            }
            this.value = value;
            return this;
        }
        public TraceTailSamplingRulesRuleFilterTraceError build() {
            final var _resultValue = new TraceTailSamplingRulesRuleFilterTraceError();
