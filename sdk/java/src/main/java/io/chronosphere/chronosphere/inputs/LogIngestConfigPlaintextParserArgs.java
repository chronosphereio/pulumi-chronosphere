...
public final class LogIngestConfigPlaintextParserArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param keepOriginal If `true`, the original log is retained after parsing and stored under the `plaintextLog` key. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        public LogIngestConfigPlaintextParserArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LogIngestConfigPlaintextParserArgs", "name");
            }
            if ($.parser == null) {
                throw new MissingRequiredPropertyException("LogIngestConfigPlaintextParserArgs", "parser");
            }
            return $;
        }
    }
