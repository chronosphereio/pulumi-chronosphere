 ...
 *             .to("blackhole}{@literal @}{@code chronosphere.io")
 *             .build());
 * 
 *     }}{@code
 * }}{@code
...
public class EmailAlertNotifier extends com.pulumi.resources.CustomResource {
     ...
     */
    public EmailAlertNotifier(java.lang.String name) {
     ...
     */
    public EmailAlertNotifier(java.lang.String name, EmailAlertNotifierArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EmailAlertNotifier(java.lang.String name, EmailAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/emailAlertNotifier:EmailAlertNotifier", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EmailAlertNotifier(java.lang.String name, Output<java.lang.String> id, @Nullable EmailAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("chronosphere:index/emailAlertNotifier:EmailAlertNotifier", name, state, makeResourceOptions(options, id), false);
    }

    private static EmailAlertNotifierArgs makeArgs(EmailAlertNotifierArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? EmailAlertNotifierArgs.Empty : args;
    }
     ...
     */
    public static EmailAlertNotifier get(java.lang.String name, Output<java.lang.String> id, @Nullable EmailAlertNotifierState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
