...
@CustomType
public final class ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority {
    /**
    ...
    private ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority() {}
    /**
     * @return Threshold expressed as a fixed value of the license, in the license&#39;s native unit.
     * 
     */
    ...
    public static Builder builder(ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentOfPoolAllocation;
        public Builder() {}
        public Builder(ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority defaults) {
        ...
        public ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority build() {
            final var _resultValue = new ResourcePoolsConfigDefaultPoolAllocationPriorityThresholdLowPriority();
