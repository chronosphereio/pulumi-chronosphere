...
public final class TraceTailSamplingRulesRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TraceTailSamplingRulesRuleArgs build() {
            if ($.filter == null) {
                throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleArgs", "filter");
            }
            if ($.sampleRate == null) {
                throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleArgs", "sampleRate");
            }
            return $;
        }
    }
