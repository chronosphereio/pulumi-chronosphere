...
public final class ConsumptionBudgetState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param consumptionConfigId ID of the singleton `chronosphere.ConsumptionConfig` resource this budget depends on. Acts as an explicit dependency pointer; the actual partition is selected via `partition_slug_path`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param priorities Priority order used when dropping data. Priority `10` is dropped first; priority `1` is dropped last.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resource Deprecated: use `threshold.sku_group` and `threshold.unit` instead. Identifies the resource type the budget governs.
         * 
         * @return builder
         * 
         * @deprecated
