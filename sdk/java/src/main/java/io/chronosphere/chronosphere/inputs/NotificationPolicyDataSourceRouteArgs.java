...
public final class NotificationPolicyDataSourceRouteArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationPolicyDataSourceRouteArgs Empty = new NotificationPolicyDataSourceRouteArgs();
    ...
    private NotificationPolicyDataSourceRouteArgs() {}

    private NotificationPolicyDataSourceRouteArgs(NotificationPolicyDataSourceRouteArgs $) {
    ...
    public static Builder builder(NotificationPolicyDataSourceRouteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyDataSourceRouteArgs();
        }

        public Builder(NotificationPolicyDataSourceRouteArgs defaults) {
            $ = new NotificationPolicyDataSourceRouteArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NotificationPolicyDataSourceRouteArgs build() {
