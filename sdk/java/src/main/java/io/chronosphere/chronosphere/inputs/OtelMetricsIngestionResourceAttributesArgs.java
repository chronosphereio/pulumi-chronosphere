...
public final class OtelMetricsIngestionResourceAttributesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param excludeKeys Resource attribute keys to exclude from the flatten operation, interpreted according to `filterMode`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param filterMode Controls how `excludeKeys` is interpreted (e.g. allow-list vs. block-list semantics).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param generateTargetInfo If true, generates a `targetInfo` time series with labels derived from resource attributes. `filterMode` and `excludeKeys` apply identically to this series. Defaults to false.
         * 
         * @return builder
         * 
         */
