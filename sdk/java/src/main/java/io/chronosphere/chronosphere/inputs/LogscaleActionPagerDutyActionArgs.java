...
public final class LogscaleActionPagerDutyActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogscaleActionPagerDutyActionArgs build() {
            if ($.routingKey == null) {
                throw new MissingRequiredPropertyException("LogscaleActionPagerDutyActionArgs", "routingKey");
            }
            if ($.severity == null) {
                throw new MissingRequiredPropertyException("LogscaleActionPagerDutyActionArgs", "severity");
            }
            return $;
        }
    }
