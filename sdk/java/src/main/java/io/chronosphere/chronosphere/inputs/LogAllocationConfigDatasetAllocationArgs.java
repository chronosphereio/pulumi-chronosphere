...
public final class LogAllocationConfigDatasetAllocationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogAllocationConfigDatasetAllocationArgs build() {
            if ($.allocation == null) {
                throw new MissingRequiredPropertyException("LogAllocationConfigDatasetAllocationArgs", "allocation");
            }
            if ($.datasetId == null) {
                throw new MissingRequiredPropertyException("LogAllocationConfigDatasetAllocationArgs", "datasetId");
            }
            return $;
        }
    }
