...
public final class TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs() {}

    private TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs(TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs $) {
    ...
    public static Builder builder(TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs();
        }

        public Builder(TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs defaults) {
        ...
        public TraceMetricsRuleTraceFilterScopeFilterSpanScopeDurationArgs build() {
            return $;
        }
    }
