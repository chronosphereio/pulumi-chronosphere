...
public final class TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyArgs build() {
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyArgs", "operation");
            }
            if ($.probabilisticStrategy == null) {
                throw new MissingRequiredPropertyException("TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyArgs", "probabilisticStrategy");
            }
            return $;
        }
    }
