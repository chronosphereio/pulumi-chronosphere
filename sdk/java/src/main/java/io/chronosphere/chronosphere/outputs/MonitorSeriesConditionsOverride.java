...
public final class MonitorSeriesConditionsOverride {
    ...
    public static final class Builder {
        ...
        public Builder conditions(List<MonitorSeriesConditionsOverrideCondition> conditions) {
            if (conditions == null) {
              throw new MissingRequiredPropertyException("MonitorSeriesConditionsOverride", "conditions");
            }
        ...
        public Builder labelMatchers(List<MonitorSeriesConditionsOverrideLabelMatcher> labelMatchers) {
            if (labelMatchers == null) {
              throw new MissingRequiredPropertyException("MonitorSeriesConditionsOverride", "labelMatchers");
            }
        ...
        public MonitorSeriesConditionsOverride build() {
            final var _resultValue = new MonitorSeriesConditionsOverride();
