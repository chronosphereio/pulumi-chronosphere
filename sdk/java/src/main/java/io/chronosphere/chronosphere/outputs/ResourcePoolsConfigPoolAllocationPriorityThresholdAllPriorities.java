...
@CustomType
public final class ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities {
    /**
    ...
    private ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities() {}
    /**
     * @return Threshold expressed as a fixed value of the license, in the license&#39;s native unit.
     * 
     */
    ...
    public static Builder builder(ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentOfPoolAllocation;
        public Builder() {}
        public Builder(ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities defaults) {
        ...
        public ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities build() {
            final var _resultValue = new ResourcePoolsConfigPoolAllocationPriorityThresholdAllPriorities();
