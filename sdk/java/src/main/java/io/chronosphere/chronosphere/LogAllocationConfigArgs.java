...
public final class LogAllocationConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param defaultDataset Allocation and priority configuration for the default dataset, which receives any logs not matched by a `datasetAllocation` entry.
         * 
         * @return builder
         * 
         */
        ...
        public LogAllocationConfigArgs build() {
            if ($.defaultDataset == null) {
                throw new MissingRequiredPropertyException("LogAllocationConfigArgs", "defaultDataset");
            }
            return $;
        }
    }
