...
public final class LogscaleAlertArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LogscaleAlertArgs() {}

    private LogscaleAlertArgs(LogscaleAlertArgs $) {
    ...
    public static Builder builder(LogscaleAlertArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogscaleAlertArgs();
        }

        public Builder(LogscaleAlertArgs defaults) {
         ...
         * 
         */
        public Builder runAsUser(Output<String> runAsUser) {
            $.runAsUser = runAsUser;
            return this;
        }
        ...
        public LogscaleAlertArgs build() {
            if ($.alertType == null) {
                throw new MissingRequiredPropertyException("LogscaleAlertArgs", "alertType");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LogscaleAlertArgs", "name");
            }
            if ($.repository == null) {
                throw new MissingRequiredPropertyException("LogscaleAlertArgs", "repository");
            }
            if ($.runAsUser == null) {
                throw new MissingRequiredPropertyException("LogscaleAlertArgs", "runAsUser");
            }
            return $;
        }
    }
