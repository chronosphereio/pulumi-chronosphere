...
public final class LogscaleActionWebhookActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogscaleActionWebhookActionArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LogscaleActionWebhookActionArgs", "method");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("LogscaleActionWebhookActionArgs", "url");
            }
            return $;
        }
    }
