    ...
    public static final class Builder {
        ...
        public Builder samplingRate(Double samplingRate) {
            if (samplingRate == null) {
              throw new MissingRequiredPropertyException("TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyProbabilisticStrategy", "samplingRate");
            }
        ...
        public TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyProbabilisticStrategy build() {
            final var _resultValue = new TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyProbabilisticStrategy();
