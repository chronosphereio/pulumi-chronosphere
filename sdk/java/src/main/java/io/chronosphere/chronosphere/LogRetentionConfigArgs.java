...
public final class LogRetentionConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LogRetentionConfigArgs build() {
            if ($.filter == null) {
                throw new MissingRequiredPropertyException("LogRetentionConfigArgs", "filter");
            }
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("LogRetentionConfigArgs", "mode");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LogRetentionConfigArgs", "name");
            }
            if ($.retentionDays == null) {
                throw new MissingRequiredPropertyException("LogRetentionConfigArgs", "retentionDays");
            }
            return $;
        }
    }
