...
public final class RollupRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RollupRuleArgs build() {
            if ($.filter == null) {
                throw new MissingRequiredPropertyException("RollupRuleArgs", "filter");
            }
            if ($.metricType == null) {
                throw new MissingRequiredPropertyException("RollupRuleArgs", "metricType");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("RollupRuleArgs", "name");
            }
            if ($.slug == null) {
                throw new MissingRequiredPropertyException("RollupRuleArgs", "slug");
            }
            return $;
        }
    }
