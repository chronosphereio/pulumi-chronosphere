...
public final class DropRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param activatedDropDuration Once a conditional drop activates, how long it stays activated before re-checking against `rateLimitThreshold`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param conditionalDrop If `true`, the drop only activates when the configured `rateLimitThreshold` is exceeded.
         * 
         * @return builder
         * 
         */
        ...
        public DropRuleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DropRuleArgs", "name");
            }
            if ($.queries == null) {
                throw new MissingRequiredPropertyException("DropRuleArgs", "queries");
            }
            return $;
        }
    }
