...
public final class SLOSli {
    ...
    public static final class Builder {
        ...
        public SLOSli build() {
            final var _resultValue = new SLOSli();
            _resultValue.additionalPromqlFilters = additionalPromqlFilters;
            _resultValue.customDimensionLabels = customDimensionLabels;
            _resultValue.customIndicator = customIndicator;
            _resultValue.customTimesliceIndicator = customTimesliceIndicator;
            return _resultValue;
        }
    }
}
