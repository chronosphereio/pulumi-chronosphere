...
public final class LogAllocationConfigDefaultDatasetPrioritiesHighPriorityFilter {
    ...
    public static final class Builder {
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("LogAllocationConfigDefaultDatasetPrioritiesHighPriorityFilter", "query");
            }
            this.query = query;
            return this;
        }
        public LogAllocationConfigDefaultDatasetPrioritiesHighPriorityFilter build() {
            final var _resultValue = new LogAllocationConfigDefaultDatasetPrioritiesHighPriorityFilter();
