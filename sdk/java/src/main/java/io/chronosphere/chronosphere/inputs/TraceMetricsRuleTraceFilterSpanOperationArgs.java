...
public final class TraceMetricsRuleTraceFilterSpanOperationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private TraceMetricsRuleTraceFilterSpanOperationArgs(TraceMetricsRuleTraceFilterSpanOperationArgs $) {
    ...
    public static Builder builder(TraceMetricsRuleTraceFilterSpanOperationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TraceMetricsRuleTraceFilterSpanOperationArgs();
        }

        public Builder(TraceMetricsRuleTraceFilterSpanOperationArgs defaults) {
        ...
        public TraceMetricsRuleTraceFilterSpanOperationArgs build() {
            return $;
        }
    }
