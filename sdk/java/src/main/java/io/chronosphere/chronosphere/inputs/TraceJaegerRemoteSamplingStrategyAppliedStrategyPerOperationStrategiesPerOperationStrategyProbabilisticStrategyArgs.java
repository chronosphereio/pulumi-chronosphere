    ...
    public static final class Builder {
        ...
        public TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyProbabilisticStrategyArgs build() {
            if ($.samplingRate == null) {
                throw new MissingRequiredPropertyException("TraceJaegerRemoteSamplingStrategyAppliedStrategyPerOperationStrategiesPerOperationStrategyProbabilisticStrategyArgs", "samplingRate");
            }
            return $;
        }
    }
