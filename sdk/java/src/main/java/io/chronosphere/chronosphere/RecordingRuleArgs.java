...
public final class RecordingRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param bucketId ID of the bucket the recording rule belongs to. At least one of `bucketId` or `executionGroup` must be set; if both are set their values must match.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param executionGroup Slug of the execution group in which the rule is evaluated. Rules in the same group run sequentially at the configured interval; all rules in a group must finish before the next iteration starts. At least one of `bucketId` or `executionGroup` must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param expr PromQL expression evaluated at each interval. The result is written to a new series named by `metricName` (or `name` if unset).
         * 
         * @return builder
         * 
         */
        ...
        public RecordingRuleArgs build() {
            if ($.expr == null) {
                throw new MissingRequiredPropertyException("RecordingRuleArgs", "expr");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("RecordingRuleArgs", "name");
            }
            return $;
        }
    }
