...
@CustomType
public final class ResourcePoolsConfigDefaultPoolPriorityThresholdDefaultAndLowPriority {
    /**
    ...
    public static Builder builder(ResourcePoolsConfigDefaultPoolPriorityThresholdDefaultAndLowPriority defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentOfPoolAllocation;
        public Builder() {}
        public Builder(ResourcePoolsConfigDefaultPoolPriorityThresholdDefaultAndLowPriority defaults) {
        ...
        public ResourcePoolsConfigDefaultPoolPriorityThresholdDefaultAndLowPriority build() {
            final var _resultValue = new ResourcePoolsConfigDefaultPoolPriorityThresholdDefaultAndLowPriority();
