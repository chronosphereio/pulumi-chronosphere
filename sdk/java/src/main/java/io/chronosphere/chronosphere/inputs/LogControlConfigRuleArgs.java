...
public final class LogControlConfigRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param type Type of control action this rule performs. Exactly one of the matching action blocks (`sample`, `dropField`, `emitMetrics`, `replaceField`, `parseField`) must be configured.
         * 
         * @return builder
         * 
         */
