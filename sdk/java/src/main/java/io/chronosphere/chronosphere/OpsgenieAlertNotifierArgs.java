...
public final class OpsgenieAlertNotifierArgs extends com.pulumi.resources.ResourceArgs {

    public static final OpsgenieAlertNotifierArgs Empty = new OpsgenieAlertNotifierArgs();
    ...
    private OpsgenieAlertNotifierArgs() {}

    private OpsgenieAlertNotifierArgs(OpsgenieAlertNotifierArgs $) {
        this.apiKey = $.apiKey;
        this.apiUrl = $.apiUrl;
    ...
    public static Builder builder(OpsgenieAlertNotifierArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpsgenieAlertNotifierArgs();
        }

        public Builder(OpsgenieAlertNotifierArgs defaults) {
            $ = new OpsgenieAlertNotifierArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param basicAuthUsername Username for HTTP basic auth when calling the Opsgenie API. Mutually exclusive with `bearerToken`.
         * 
         * @return builder
         * 
         */
        ...
        public OpsgenieAlertNotifierArgs build() {
            if ($.apiKey == null) {
                throw new MissingRequiredPropertyException("OpsgenieAlertNotifierArgs", "apiKey");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OpsgenieAlertNotifierArgs", "name");
            }
            return $;
        }
    }
