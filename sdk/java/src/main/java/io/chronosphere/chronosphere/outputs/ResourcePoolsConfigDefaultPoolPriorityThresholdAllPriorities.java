...
public final class ResourcePoolsConfigDefaultPoolPriorityThresholdAllPriorities {
    ...
    public static Builder builder(ResourcePoolsConfigDefaultPoolPriorityThresholdAllPriorities defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double percentOfPoolAllocation;
        public Builder() {}
        public Builder(ResourcePoolsConfigDefaultPoolPriorityThresholdAllPriorities defaults) {
        ...
        public ResourcePoolsConfigDefaultPoolPriorityThresholdAllPriorities build() {
            final var _resultValue = new ResourcePoolsConfigDefaultPoolPriorityThresholdAllPriorities();
