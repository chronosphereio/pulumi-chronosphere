    ...
    public static final class Builder {
        ...
        public DerivedMetricQueryQueryVariableArgs build() {
            if ($.defaultSelector == null) {
                throw new MissingRequiredPropertyException("DerivedMetricQueryQueryVariableArgs", "defaultSelector");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DerivedMetricQueryQueryVariableArgs", "name");
            }
            return $;
        }
    }
