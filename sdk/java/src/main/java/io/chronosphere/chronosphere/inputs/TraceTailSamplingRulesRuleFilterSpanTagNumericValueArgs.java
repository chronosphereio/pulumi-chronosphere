...
public final class TraceTailSamplingRulesRuleFilterSpanTagNumericValueArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TraceTailSamplingRulesRuleFilterSpanTagNumericValueArgs build() {
            if ($.comparison == null) {
                throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterSpanTagNumericValueArgs", "comparison");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("TraceTailSamplingRulesRuleFilterSpanTagNumericValueArgs", "value");
            }
            return $;
        }
    }
