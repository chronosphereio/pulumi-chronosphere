...
public final class DatasetConfigurationTraceDatasetMatchCriteriaSpanError {
    ...
    public static final class Builder {
        ...
        public Builder value(Boolean value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DatasetConfigurationTraceDatasetMatchCriteriaSpanError", "value");
            }
            this.value = value;
            return this;
        }
        public DatasetConfigurationTraceDatasetMatchCriteriaSpanError build() {
            final var _resultValue = new DatasetConfigurationTraceDatasetMatchCriteriaSpanError();
