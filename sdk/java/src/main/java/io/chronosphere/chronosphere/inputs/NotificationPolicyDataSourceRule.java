...
public final class NotificationPolicyDataSourceRule extends com.pulumi.resources.InvokeArgs {

    public static final NotificationPolicyDataSourceRule Empty = new NotificationPolicyDataSourceRule();
    ...
    private NotificationPolicyDataSourceRule(NotificationPolicyDataSourceRule $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyDataSourceRule();
        }

        public Builder(NotificationPolicyDataSourceRule defaults) {
            $ = new NotificationPolicyDataSourceRule(Objects.requireNonNull(defaults));
        }
