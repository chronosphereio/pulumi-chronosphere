...
replace (
	...
	//       (pulumi-cs-v2.40.0) is the Pulumi fork's upstream-v2.40.0 branch plus the Chronosphere set-handling fixes
	//       cherry-picked from the fork's sophia/v2.40.1 branch. To rebase for a future plugin-sdk bump: branch from the new
	//       pulumi/terraform-plugin-sdk upstream-vX.Y.Z branch and cherry-pick those same fixes.
	...
	github.com/hashicorp/terraform-plugin-sdk/v2 => github.com/chronosphereio/terraform-plugin-sdk/v2 v2.0.0-20260713170048-15518702811e
)
...
require (
	...
	github.com/chronosphereio/terraform-provider-chronosphere v1.32.0 // indirect
